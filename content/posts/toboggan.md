...
The original project was created by [Igor Laborie](https://github.com/ilaborie/toboggan) (@ilaborie).     
[I](https://github.com/Tednoob17) forked and significantly modified the project to make it more accessible, easier to build, and simpler to distribute.     
While inspired by Igor's original work, this version includes many improvements and tweaks to make it practical for personal use and easier to work with. The current **Toboggan** repository is at [toboggan](https://github.com/Tednoob17/toboggan).
